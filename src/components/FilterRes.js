...
function FilterRes() {
  const filterButtonStyle =
    "whitespace-nowrap focus:bg-orange-500 focus:text-white focus:border-1 focus:border-orange-400 border p-2 px-4 rounded-3xl cursor-pointer border-gray-300 items-center flex justify-center gap-2 ";
