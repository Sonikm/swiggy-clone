...
export function OrderSummary() {
  ...
  return (
    <div className=" flex flex-1 flex-col gap-8 px-8">
      <h2 className="whitespace-nowrap text-center text-2xl">Order Summary</h2>
      <div className="mb-5 flex h-full  flex-col justify-between gap-4">
       ...
       <Link to="order" className="bg-orange-500 text-center hover:bg-orange-600">
       <button className="outline-none p-3  text-white">PLACE ORDER</button>
       </Link>
       

        <div className="flex flex-col gap-2">
          <h4 className="text-sm">WE ACCEPT</h4>
          <img
